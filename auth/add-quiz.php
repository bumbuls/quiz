    ...
    <div class="container">
        <div class="forms">
            <div class="form login">
                ...
                <?php } ?>
                <form action="../process/addQuizProcess.php" method="post">
                    <div class="input-field">
                        <?php if (isset($_GET['q_name'])) { ?>
                        <input type="text" name="q_name" value="<?php echo $_GET['q_name']; ?>" placeholder="Ievadi nosaukumu">
                        <i class="uil uil-notes icon"></i>
                        <?php }else{ ?>
                            <input type="text" name="q_name"  placeholder="Ievadi nosaukumu">
                            <i class="uil uil-notes icon"></i>
                        <?php }?>
                    </div>
                    <div class="input-field">
                        ...
                        <?php }else{ ?>
                            <input type="text" name="q_time" placeholder="Laiks (min)">
                            <i class="uil uil-clock icon"></i>
                        <?php }?>
                    </div>
                    <div class="input-field button">
                        <input type="submit" name="addQuiz" value="Saglabāt">
                    </div>
                </form>
            </div>
